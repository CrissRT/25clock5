        ...
        return(
            <>
                ...
                <div id='buttons' className='mt-2 d-flex justify-content-between align-items-center'>
                    <div id="start_stop">
                        <i className="bi bi-play-fill position-relative" onClick={() => this.props.handlePlayAndPauseForBreak("button")}/>  
                        <i className="bi bi-pause-fill" onClick={() => this.props.handlePlayAndPauseForBreak("button")}/>
                    </div>
